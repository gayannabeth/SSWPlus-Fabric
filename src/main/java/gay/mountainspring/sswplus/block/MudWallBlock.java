...
public class MudWallBlock extends WallBlock {
	public static final MapCodec<WallBlock> CODEC = createCodec(MudWallBlock::new);
	...
	public MudWallBlock(Settings settings) {
		super(settings);
