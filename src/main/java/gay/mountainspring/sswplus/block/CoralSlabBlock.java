...
public class CoralSlabBlock extends SlabBlock implements Coral {
	public static final MapCodec<CoralSlabBlock> CODEC = RecordCodecBuilder.mapCodec(
			instance -> instance.group(CoralBlockBlock.DEAD_FIELD.forGetter(block -> block.deadBlock), createSettingsCodec())
			.apply(instance, CoralSlabBlock::new));
	
	protected final Block deadBlock;
	
	@Override
	public MapCodec<CoralSlabBlock> getCodec() {
		return CODEC;
	}
	
	public CoralSlabBlock(Block deadBlock, Settings settings) {
		super(settings);
