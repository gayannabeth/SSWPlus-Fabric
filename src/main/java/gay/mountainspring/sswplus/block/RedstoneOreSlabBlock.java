...
public class RedstoneOreSlabBlock extends ExperienceDroppingSlabBlock {
	public static final MapCodec<RedstoneOreSlabBlock> CODEC = createCodec(RedstoneOreSlabBlock::new);
	public static final BooleanProperty LIT = RedstoneOreBlock.LIT;
	
	@Override
	public MapCodec<RedstoneOreSlabBlock> getCodec() {
		return CODEC;
	}
	
	public RedstoneOreSlabBlock(Settings settings) {
		super(UniformIntProvider.create(1, 5), UniformIntProvider.create(1, 2), settings);
