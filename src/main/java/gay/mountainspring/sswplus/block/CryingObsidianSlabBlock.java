...
public class CryingObsidianSlabBlock extends SlabBlock {
	public static final MapCodec<CryingObsidianSlabBlock> CODEC = createCodec(CryingObsidianSlabBlock::new);
	
	@Override
	public MapCodec<CryingObsidianSlabBlock> getCodec() {
		return CODEC;
	}
	
	public CryingObsidianSlabBlock(Settings settings) {
		super(settings);
	}
